 ...
 *
 */
function ContainerRegistry(credentials, subscriptionId, baseUri, options) {
  ...
  ContainerRegistry['super_'].call(this, credentials, options);
...
util.inherits(ContainerRegistry, ServiceClient);
